                    ...
                    <td class="text-right">
                      <v-dialog max-width="500" v-model="value.current">
                        <template v-slot:activator="{ on, attrs }">
                          <v-btn v-bind="attrs" v-on="on"  color="#D50000" dark class="mr-5">
                            Reject
                          </v-btn>
                        </template>
                        ...
                        <v-card>
                          <v-card-title>
                            Are you sure you want to reject this admin registration request?
                          </v-card-title>
                          ...
                          <v-card-actions>
                            <v-container fluid>
                              <v-row>
                                ...
                                <v-col>
                                  <v-btn @click="rejectAdminRequest(value)" color="#D50000" dark>
                                    Confirm
                                  </v-btn>
                                </v-col>
                              </v-row>
                      ...
                      <v-dialog max-width="500" v-model="value.current">
                        ...
                        <v-card>
                          <v-card-title>
                            Are you sure you want to accpet this admin registration request?
                          </v-card-title>
                          ...
                          <v-card-actions>
                            <v-container fluid>
                              <v-row>
                                ...
                                <v-col>
                                  <v-btn @click="acceptAdminRequest(value)" color="#D50000" dark>
                                    Confirm
                                  </v-btn>
                                </v-col>
                              </v-row>
  ...
  export default {
    ...
    methods: { 
      async acceptAdminRequest(admin_request) {
        ...
        await axios.post('admin/acceptAdminRequest', 
          {
            id: admin_request.id,
          },
          {
