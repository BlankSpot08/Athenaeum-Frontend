      ...
      <v-container class="mb-10">
        ...
        <ul>
          <li>
            ...
            this Disclaimer) refers to Athenaeum, Quezon City.
          </li>
          ...
          <li>
            <strong>Website</strong> refers to Athenaeum, accessible from
            <a
              href="www.athenaeum.com"
        ...
        <ul>
          <li>By phone number: 09673327890</li>
        </ul>
      </v-container>
    </v-main>
  </v-app>
